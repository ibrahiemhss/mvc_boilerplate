...
class ForgetPasswordWidget extends StatefulWidget {
  ...
  const ForgetPasswordWidget(this.context,{Key key}) : super(key: key);
  @override
  _ForgetPasswordWidgetState createState() => _ForgetPasswordWidgetState(context);
}

class _ForgetPasswordWidgetState extends StateMVC<ForgetPasswordWidget> {
  UserController _con;

  _ForgetPasswordWidgetState(context) : super(UserController(context)) {
    _con = controller;
  }
  @override
  void initState() {
