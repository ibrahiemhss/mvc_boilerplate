...
class NotificationsWidget extends StatefulWidget {
  ...
  NotificationsWidget(this.context,{Key key, this.parentScaffoldKey}) : super(key: key);

  @override
  _NotificationsWidgetState createState() => _NotificationsWidgetState(context);
}

class _NotificationsWidgetState extends StateMVC<NotificationsWidget> {
  NotificationController _con;

  _NotificationsWidgetState(context) : super(NotificationController(context)) {
    _con = controller;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () {
          _con.refreshNotifications(context);
        },
                      ...
                      return NotificationItemWidget(
                        ...
                        onMarkAsRead: () {
                          _con.doMarkAsReadNotifications(
                              context, _con.notifications.elementAt(index));
                        },
                        onMarkAsUnRead: () {
