...
class LoginWidget extends StatefulWidget {
  ...
  const LoginWidget(this.context,{Key key}) : super(key: key);

  @override
  _LoginWidgetState createState() => _LoginWidgetState(context);
}

class _LoginWidgetState extends StateMVC<LoginWidget> {
  UserController _con;

  _LoginWidgetState(context) : super(UserController(context)) {
    _con = controller;
  }
                  ...
                  FlatButton(
                    onPressed: () {
                      Navigator.of(context)
                          .pushReplacementNamed(RouteGenerator.forgetPassword);
                    },
