...
class HelpWidget extends StatefulWidget {
  ...
  const HelpWidget(this.context, {Key key}) : super(key: key);

  @override
  _HelpWidgetState createState() => _HelpWidgetState(context);
}

class _HelpWidgetState extends StateMVC<HelpWidget> {
  FaqController _con;

  _HelpWidgetState(context) : super(FaqController(context)) {
    _con = controller;
  }
