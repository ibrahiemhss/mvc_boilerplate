...
import 'package:mvc_boilerplate/src/models/chat.dart';
import 'package:mvc_boilerplate/src/models/conversation.dart';
...
//  }
  ...
  Future signInWithToken(String token) async {
    try {
      _auth.signInWithCustomToken(token).then((value) {
        if (value != null) {
          return true;
        } else {
          return null;
