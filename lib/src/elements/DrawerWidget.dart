      ...
      child: currentUser.value.apiToken == null
          ...
          : ListView(
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).pushNamed(RouteGenerator.pages, arguments: 0);
                  },
                ...
                ListTile(
                  onTap: () {
                    Navigator.of(context).pushNamed(RouteGenerator.pages, arguments: 1);
                  },
                  leading: Icon(
                    Icons.store,
                ...
                ListTile(
                  onTap: () {
                    Navigator.of(context).pushNamed(RouteGenerator.pages, arguments: 2);
                  },
                  leading: Icon(
                    Icons.fastfood,
                    color: Theme.of(context).focusColor.withOpacity(1),
                ...
                ListTile(
                  onTap: () {
                    Navigator.of(context).pushNamed(RouteGenerator.pages, arguments: 3);
                  },
                  leading: Icon(
                    Icons.chat,
                    color: Theme.of(context).focusColor.withOpacity(1),
                ...
                ListTile(
                  onTap: () {
                    Navigator.of(context).pushNamed(RouteGenerator.help);
                  },
                  leading: Icon(
                    Icons.help,
                    color: Theme.of(context).focusColor.withOpacity(1),
                ...
                ListTile(
                  onTap: () {
                    Navigator.of(context).pushNamed(RouteGenerator.pages, arguments: 4);
                  },
                  leading: Icon(
                    Icons.settings,
                    color: Theme.of(context).focusColor.withOpacity(1),
                ...
                ListTile(
                  onTap: () {
                    Navigator.of(context).pushNamed(RouteGenerator.languages);
                  },
                  leading: Icon(
                    Icons.translate,
                    color: Theme.of(context).focusColor.withOpacity(1),
                ...
                ListTile(
                  onTap: () {
                    if (Theme.of(context).brightness == Brightness.dark) {
                      settingRepo.setBrightness(Brightness.light);
                      setting.value.brightness.value = Brightness.light;
                    } else {
                      setting.value.brightness.value = Brightness.dark;
                      settingRepo.setBrightness(Brightness.dark);
                    }
                ...
                ListTile(
                  onTap: () {
                    userRepo. logout().then((value) {
                      Navigator.of(context).pushNamedAndRemoveUntil(RouteGenerator.login, (Route<dynamic> route) => false);
                    });
                  },
                  leading: Icon(
                    Icons.exit_to_app,
