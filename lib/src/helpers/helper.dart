...
//        },
                ...
                children: <TextSpan>[
                  TextSpan(
                    ...
                    style: style == null
                        ...
                        : style.merge(TextStyle(
                            fontWeight: FontWeight.w400,
                            fontSize:style.fontSize!=null? style.fontSize?? - 6:style.fontSize)),
                  ),
                ],
              ),
      );
  ...
  static Html applyHtml(context, String html, {required TextStyle style}) {
    return Html(
      data: html ,
      style: {
        "*": Style(
  ...
  String trans(String text) {
    switch (text) {
      case "App\\Notifications\\1":
        return "text1";
      case "App\\Notifications\\2":
        return "text2";
      case "App\\Notifications\\3":
        return "text3";
      default:
        return "";
    }
